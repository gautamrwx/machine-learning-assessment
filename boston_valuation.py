...
# Function For Estimating [price in log]
...
# Scale factor will be use to convert old dollar value into current dollar value
ZILLOW_MEDIAN_PRICE = 583.3
SCALE_FACTOR = ZILLOW_MEDIAN_PRICE / np.median(boston_dataset.target)

# Function For Estimating [price in Dollar ]
